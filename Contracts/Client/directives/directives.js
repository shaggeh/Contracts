            ...
            link(scope, element) {
                $(document).ready(function () {
                        var $select = $(element).find("select"),
                            $selectButton = "<div class=\"hc-select-button cursor-pointer\"></div>",
                            $selectWrapper = "<div class=\"hc-select-wrapper\"></div>",
                            $selectOptionsWrapper = "<ul class=\"hc-select-options text-left\"></ul>",
                            $pageWrapper = $("body");
